...
public class TextCompositeSortTest extends Assert {
	TextComposite expectedResultSentence;
	...
	public void testSortBySentencesNumber(TextComposite expectedResult) {
